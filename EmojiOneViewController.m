...
@interface EmojiOneViewController ()<FaceToolBarDelegate,HPGrowingTextViewDelegate,UITableViewDataSource, UITableViewDelegate>
{
...
@implementation EmojiOneViewController
...
-(void)getUseData
{
    ...
    useMessage1.content = @" 哈哈哈哈[f001][f066] 😄哈哈";
    ...
    useMessage2.content = @"我哈哈哈[f031][f066] 😄我哈哈哈[f031]不知道这😄😄😄😄😄😄😄😄😄也我哈哈哈[f031][f066]我哈哈哈[f031][f066]写不清楚找也找不到我不知道这真的是什么在那里也我哈哈哈[f031][f066]我哈哈哈[f031][f066]写不清楚找也找不到我不知道这真的是什么在那里我哈哈哈[f031]不知道这也我哈哈哈[f031][f066]我哈哈哈[f031][f066]写不清楚找也找不到我不知道这真的是什么在那里也我哈哈哈[f031][f066]我哈哈哈[f031][f066]写不清楚找也找不到我不知道这真";
    ...
    [_allMessagesFrame addObject:useMessage1];
    [_allMessagesFrame addObject:useMessage2];
    useMessage1.content = @" 哈哈哈哈[f001][f066] 😄哈哈哈哈哈哈哈哈";
    [_allMessagesFrame addObject:useMessage1];
//    [_allMessagesFrame addObject:useMessage2];
//    [_allMessagesFrame addObject:useMessage1];
    ...
    useMessage3.type = 0;
    useMessage3.icon = @"";
    useMessage3.time = @"2015-06-15 13:16:08";
    useMessage3.phone = @"3561";
    useMessage3.content = @"，写也我哈哈哈[f031][f066]我哈哈哈[f031][f066]写不清楚找也找不到我不知道这真的是什么在的的的么在的的么在的么在的的";
...
{
    static NSString *CellIdentifier = @"EmojiOneCell";
    EmojiOneCell *cell = (EmojiOneCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    if (cell == nil)
    {
        cell = [[EmojiOneCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
...
{
    EmojiOneCell *cell = (EmojiOneCell *)[self tableView:tableView cellForRowAtIndexPath:indexPath];
